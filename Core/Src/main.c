...
/* Definitions for carReceiveTask */
osThreadId_t carReceiveTaskHandle;
uint32_t carReceiveBuffer[ 400 ];
osStaticThreadDef_t carReceiveControlBlock;
const osThreadAttr_t carReceiveTask_attributes = {
  .name = "carReceiveTask",
  .cb_mem = &carReceiveControlBlock,
  .cb_size = sizeof(carReceiveControlBlock),
  .stack_mem = &carReceiveBuffer[0],
  .stack_size = sizeof(carReceiveBuffer),
  .priority = (osPriority_t) osPriorityNormal,
};
/* Definitions for canTransmitTask */
osThreadId_t canTransmitTaskHandle;
uint32_t canTransmitTaskBuffer[ 400 ];
...
int main(void)
{
  ...
  /* creation of carReceiveTask */
  carReceiveTaskHandle = osThreadNew(StartCanReceiveTask, NULL, &carReceiveTask_attributes);

  /* creation of canTransmitTask */
  canTransmitTaskHandle = osThreadNew(StartCanTransmitTask, NULL, &canTransmitTask_attributes);
...
/**
* @brief Function implementing the carReceiveTask thread.
* @param argument: Not used
* @retval None
*/
